//! runtime definition. This module is compiled twice, first to wasm, then to native.
//! The native version exports the wasm versio of itself as `pub const WASM_BINARY: &[u8];`

// Make the WASM binary available.
#[cfg(feature = "std")]
include!(concat!(env!("OUT_DIR"), "/wasm_binary.rs"));

// tell dead_code checker to ignore WASM_BINARY_BLOATY
#[cfg(feature = "std")]
#[allow(dead_code)]
...
const EPOCH_DURATION_IN_BLOCKS: u32 = 10 * MINUTES;
